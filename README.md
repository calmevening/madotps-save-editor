...
~~It is speculated by the repo maintainer that this file format is also used in the lost game "M.N.I.B.R." ("Manicured Nails in Bloody Red"), a first person shooter created by the same developer of the TPS games.~~ 5-8-2026: Manicured Nails in Bloody Red does not use the same format as the Madoka TPS games.
